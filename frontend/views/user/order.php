...
$this->registerJs(
	...
	.'var drawProposals = function(proposals){'
		...
		.'var html = "<div class=\"proposals-card mdl-card mdl-shadow--2dp\">'
						.'<table class=\"md-table md-row-select\">'
							.'<thead class=\"md-head\">'
								.'<tr class=\"md-row\">'
	            			...
	            			.'<tbody class=\"md-body\">'
								.'<tr class=\"md-row\">'
		                			.'<td class=\"md-cell\">Светлана Вертипрахова</td>'
		                			.'<td class=\"md-cell\">50% перед работой 50% по завершению</td>'
		                			.'<td class=\"md-cell\">1 неделя</td>'
		                			.'<td class=\"md-cell md-numeric\">2000</td>'
	              				.'</tr>'
								.'<tr class=\"md-row\">'
		                			.'<td class=\"md-cell\">Александр Вертипрахова</td>'
		                			.'<td class=\"md-cell\">40% перед работой 60% по завершению</td>'
		                			.'<td class=\"md-cell\">2 неделя</td>'
		                			.'<td class=\"md-cell md-numeric\">1000</td>'
	              				.'</tr>'
	              			.'</tr>'
	            		.'</tbody>'
	            	.'</table>'
	...
	.'var drawProposal = function(proposal){'
		...
		.'html += "<td class=\"md-cell\">"+proposal["firstName"]+" "+proposal["lastName"]+"</td>";'
		.'var schedules = "";'
		...
		.'html += "<td class=\"md-cell\">"+schedules+"</td>";'
		.'html += "<td class=\"md-cell md-numeric\">"+proposal["price"]+"</td>";'
		.'html += "</tr>";'
		.'return html;'
	.'};'
