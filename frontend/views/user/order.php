...
$this->registerJs(
	...
	.'var drawMessages = function(messages){'
		.'var content = $("#tab-content");'
		.'content.empty();'
		.'var html = "<ul class=\'messages mdl-list mdl-shadow--2dp\'>";'
	...
	.'var drawMessage = function(message){'
		.'return "<a href=\'#messages?'.(Yii::$app->user->identity->master?'userId="+message["userId"]+"':'masterId="+message["masterId"]+"').'\' class=\'mdl-list__item mdl-list__item--two-line\'>'
					.'<div class=\'mdl-list__item-avatar\' style=\"background-image: url(\'"+message["avatar"]+"\');\"></div>'
    				.'<div class=\'mdl-list__item-primary-content\'>'
						.'<time class=\'mdl-list__item-secondary-info\'>"+message["dateStr"]+"</time>'
						.'<span>"+message["interlocutor"]+"</span>'
  				...
  				.'</a>";'
	.'};'
	.'var drawCorrespondence = function(result){'
		.'var content = $("#tab-content");'
		.'content.empty();'
		.'var interlocutor = result["interlocutor"];'
		.'var html = "<div class=\'correspondence demo-card-wide mdl-card mdl-shadow--2dp\'>'
						.'<div class=\"mdl-card__title\">'
							.'<a href=\'#messages\' class=\'mdl-button mdl-js-button mdl-js-ripple-effect\'>'
								.'<i class=\'material-icons\'>keyboard_arrow_left</i>'
  								.'"+interlocutor["firstName"]+" "+interlocutor["lastName"]+"'
							.'</a>'
  						.'</div>";'
		.'html += "<ul class=\'messages mdl-list\'>";'
		.'html += "</ul>";'
		.'html += "</div>";'
