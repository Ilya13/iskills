	...
	<div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
	  ...
	  <div class="mdl-tabs__panel mdl-color--grey-100" id="about-panel">
	  	<div class="section container">
		    ...
		    <div class="mdl-typography--title mdl-typography--font-thin"><?=$master->getInfo()->about ?></div>
		</div>
	  </div>
	  <div class="mdl-tabs__panel mdl-color--white" id="policies-panel">
	  	<div class="section container">
		    <div class="mdl-typography--title">Доставка и Гарантии</div>
		    <div class="mdl-typography--title mdl-typography--font-thin"><?=$master->getInfo()->shipping ?></div>
		    <div class="mdl-typography--title mdl-typography--font-thin"><?=$master->getInfo()->policies ?></div>
		</div>
	  </div>
